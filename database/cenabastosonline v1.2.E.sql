...
CREATE TABLE localComercial (
                ...
                parcialVendido DOUBLE NOT NULL,
                parcialVendidoAdmin DOUBLE NOT NULL,
                estaAbierto BOOLEAN NOT NULL,
...
ALTER TABLE localComercial MODIFY COLUMN parcialVendido DOUBLE COMMENT ' la tabla cierreDeCaja';

ALTER TABLE localComercial MODIFY COLUMN parcialVendidoAdmin DOUBLE COMMENT 'administraci�n, funciona con la tabla cierreDeCajaAdmin';


CREATE TABLE cierreDeCajaAdmin (
                pkIdCierreDeCajaAdmin BIGINT AUTO_INCREMENT NOT NULL,
                fkIdLocalComercial BIGINT NOT NULL,
                fechaInicioPeriodo_ VARCHAR(19) NOT NULL,
                fechaFinPeriodo_ VARCHAR(19) NOT NULL,
                fechaInicioPeriodoInt_ INT NOT NULL,
                fechaFinPeriodoInt_ INT NOT NULL,
                PRIMARY KEY (pkIdCierreDeCajaAdmin)
);


CREATE TABLE cierreDeCaja (
                pkIdCierreDeCaja_ BIGINT AUTO_INCREMENT NOT NULL,
                fkIdLocalComercial BIGINT NOT NULL,
                fechaInicioPeriodo_ VARCHAR(19) NOT NULL,
                fechaFinPeriodo_ VARCHAR(19) NOT NULL,
                fechaInicioPeriodoInt INT NOT NULL,
                fechaFinPeriodoInt INT NOT NULL,
                PRIMARY KEY (pkIdCierreDeCaja_)
);
...
CREATE TABLE presentacionProducto (
                ...
                detallesProducto VARCHAR(255) NOT NULL,
...
ALTER TABLE cierreDeCaja ADD CONSTRAINT localcomercial_cierredecaja_fk
FOREIGN KEY (fkIdLocalComercial)
REFERENCES localComercial (pkIdLocalComercial)
ON DELETE RESTRICT
ON UPDATE CASCADE;

ALTER TABLE cierreDeCajaAdmin ADD CONSTRAINT localcomercial_cierredecajaadmin_fk
FOREIGN KEY (fkIdLocalComercial)
REFERENCES localComercial (pkIdLocalComercial)
ON DELETE RESTRICT
ON UPDATE CASCADE;
